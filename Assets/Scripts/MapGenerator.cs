...
public class MapGenerator : MonoBehaviour
{
    ...
    public void GenerateMap(){
        ...
        else if(drawMode == DrawMode.Mesh)display.DrawMesh(MeshGenerator.GenerateTerrainMesh(noiseMap), TextureGenerator.TextureFromColourMap(colourMap, mapWidth, mapHeight));
    }
